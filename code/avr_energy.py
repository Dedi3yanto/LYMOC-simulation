...
data1 = pd.read_csv('loc_avr_enrgy_cost.csv', header=None, names=['Data 1'])
data2 = pd.read_csv('off_avr_enrgy_cost.csv', header=None, names=['Data 2'])
data3 = pd.read_csv('dist_avr_enrgy_cost.csv', header=None, names=['Data 3'])
data4 = pd.read_csv('dyn_avr_enrgy_cost.csv', header=None, names=['Data 4'])
